 ...
 *
 * @param {boolean} [freezeAllDragEvents=false] - <a id="freeze-all-drag-events" href="#freeze-all-drag-events">🔗</a> Disables manipulation of graph
 * nodes through drag and drop. *Note: this property can only be set in the first mount, it does not update dynamically.*
